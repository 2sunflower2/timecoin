    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Timecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  timecoind [options]                     " + "\n" +
                  "  timecoind [options] <command> [params]  " + _("Send command to -server or timecoind") + "\n" +
                  "  timecoind [options] help                " + _("List commands") + "\n" +
                  "  timecoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: timecoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Timecoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Timecoin is probably already running."), strDataDir.c_str()));
